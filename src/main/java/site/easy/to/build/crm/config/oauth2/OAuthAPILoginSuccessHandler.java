...
@Component
public class OAuthAPILoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Autowired
    public OAuthAPILoginSuccessHandler(OAuthUserService oAuthUserService, UserService userService, UserProfileService userProfileService,
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        if (loggedUser != null && loggedUser.getOauthUser() == null && oAuthUser == null) {
            ...
            if (user.getStatus().equals("inactive")) {
                ...
                response.sendRedirect("/api/auth/oauth2/google?code=TOKEN");
            }
        }
    }
}